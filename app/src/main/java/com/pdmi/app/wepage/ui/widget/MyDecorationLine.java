...
/**
 * Created by guoxiuli on 2017/3/2.
 */

public class MyDecorationLine extends RecyclerView.ItemDecoration{
  ...
  public MyDecorationLine(Context context, int orientation) {
