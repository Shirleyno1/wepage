...
/**
 * Created by guoxiuli on 2017/3/8.
 */

public class MyHorizontalDividerItemDecoration extends MyFlexibleDividerDecoration {

  private MarginProvider mMarginProvider;

  protected MyHorizontalDividerItemDecoration(Builder builder) {
    super(builder);
  ...
  public static class Builder extends MyFlexibleDividerDecoration.Builder<Builder> {
    ...
    public MyHorizontalDividerItemDecoration build() {
      checkBuilderParams();
      return new MyHorizontalDividerItemDecoration(this);
    }
  }
}