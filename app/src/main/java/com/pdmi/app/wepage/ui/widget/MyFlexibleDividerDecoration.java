...
public abstract class MyFlexibleDividerDecoration extends RecyclerView.ItemDecoration {
  ...
  protected MyFlexibleDividerDecoration(Builder builder) {
  ...
  public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
    ...
    for (int i = 0; i < validChildCount; i++) {
      ...
      //guoxiuli
      if (((i+1) < validChildCount && adapter.getItemViewType(i+1) != 1)||adapter.getItemViewType(i) != 1) {
        // Don't draw divider for the seperator
        continue;
      }
